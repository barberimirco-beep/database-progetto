...
Per visualizzare la pagina web è necessario inserire nella barra di ricerca l'indirizzo IPv4 del server a cui si è connessi e la porta su cui si trova il sito web (IPv4 SERVER : PORTA)
